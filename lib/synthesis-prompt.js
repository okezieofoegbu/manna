...
//
// The Manna v0.1.4 synthesis prompt — v1.0.
//
...
export const SYNTHESIS_PROMPT_VERSION = 'v1.0';
...
to emit. Emails you've decided to skip do not appear in the array.
...
commentary. If no emails deserve to be emitted, return [].
