...
export async function readBriefForDate(date) {
  ...
  const { data, error } = await supabase
    .from('brief_items')
    .select(
      'id, date, source_email_id, source_link, sender, subject, category, synthesis, body_excerpt, suggested_owner, time_estimate, state, system_flag, prompt_version, created_at',
    )
    .eq('date', date)
