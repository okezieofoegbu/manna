...
//
// Note: this assumes account index 0 (`/u/0/`). If the user is signed
// into multiple Google accounts in the same browser, Gmail picks the
// account based on the index in the URL — 0 is "default account."
// For Manna this is fine because Okezie's primary signed-in account
// for the page is the Vitalis Workspace account.
